        ...
        <div className="row">
          <div className="col-xl-6">
            <div className="img-box1">
              <div className="img1">
                <img src="/assets/img/normal/1.jpg" alt="About" />
              </div>
              <div className="img2">
                <img src="/assets/img/normal/2.jpg" alt="About" />
              </div>
              <div className="img3">
                <img src="/assets/img/normal/3.jpg" alt="About" />
              </div>
            </div>
          </div>
          <div className="col-xl-6">
            <div className="ps-xl-4 ms-xl-2">
              <div className="title-area mb-20 pe-xl-5 me-xl-5">
                <span className="sub-title style1 ">What's PStudent?</span>
                <h2 className="sec-title mb-20 pe-xl-5 me-xl-5 heading">
                  A starter guide for international students
                </h2>
                <p className="sec-text mb-30">
                  PStudent is a platform that provides information and support
                  for international students in Vietnam. It is a project
                  developed by a group of students at PTIT.
                </p>
              </div>
                ...
                <div className="about-item">
                  ...
                  <div className="about-item_centent">
                    ...
                    <p className="about-item_text">
                      ...
                      such as tourist attractions, restaurants, and other places
                      of interest.
                    </p>
                  </div>
                </div>
